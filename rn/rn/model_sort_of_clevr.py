...
def build_model(
        images, questions, answers, model_type='rn', tag_positions=True):
    """
    ...
    if tag_positions:
        ...
        tensors = tf.reshape(tensors, [-1, 64, 256])

    # NOTE: build object pairs, the depth is
    #       256(final layer) + 2 (coordiante) -> [N, 64, 258]
    ...
    if model_type == 'rn':
        ...
        object_list = [tf.concat([o, questions_temp], axis=-1) for o in tensors_list]
